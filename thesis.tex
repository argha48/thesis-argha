...
\newcommand{\graddate}{January, 2020}
\usepackage{fancyhdr}
\usepackage{graphicx}
...
%%    \newpage
    ...
    \input{Chapters/02_fundamentals_of_light}
    \newpage
    
    \input{Chapters/03_topological_modes}
    \newpage 
    
   \input{Chapters/04_intermediate}
   \newpage
   
   \input{Chapters/05_QM_analogy}
   \newpage
